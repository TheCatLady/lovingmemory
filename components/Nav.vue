<template>
        ...
        <li><NuxtLink to="/"><span class="icon">
          ...
          </span><span class="menu">Home</span><span class="menu">主頁</span></NuxtLink></li>
        <li><NuxtLink to="/service"><span class="icon">
          ...
          </span><span class="menu">Service</span><span class="menu">追思儀式</span></NuxtLink></li>
        <li><NuxtLink to="/livestream"><span class="icon">
          ...
          </span><span class="menu">Livestream</span><span class="menu">網路直播</span></NuxtLink></li>
        <li><NuxtLink to="/gallery"><span class="icon">
          ...
          </span><span class="menu">Gallery</span><span class="menu">相片集錦</span></NuxtLink></li>
      </ul>
